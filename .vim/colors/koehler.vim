...
hi StatusLineNC   term=reverse	ctermfg=white ctermbg=darkblue guifg=white guibg=darkblue
hi Title		  term=bold  cterm=bold  ctermfg=red  gui=bold	guifg=Magenta
...
hi PreProc		  term=underline  ctermfg=darkyellow   guifg=#ff80ff
